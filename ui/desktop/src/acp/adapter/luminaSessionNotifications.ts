...
export function applyLuminaSessionNotification(
  state: AdapterState,
...
function applyStatusMessage(
  state: AdapterState,
  sessionId: string,
  update: Extract<LuminaSessionNotification_unstable['update'], { sessionUpdate: 'status_message' }>
): AcpChatStateChange[] {
...
function applyMessageUsage(
  state: AdapterState,
  update: Extract<LuminaSessionNotification_unstable['update'], { sessionUpdate: 'message_usage' }>
): AcpChatStateChange[] {
