...
export async function acpListSchedules(): Promise<ScheduledJobDto[]> {
  ...
  const listPromise = (async () => {
    ...
    const response = await client.lumina.schedulesList_unstable({});
...
export async function acpCreateSchedule(
  ...
  try {
    const client = await getAcpClient();
    const response = await client.lumina.schedulesCreate_unstable(request);
...
export async function acpDeleteSchedule(scheduleId: string): Promise<void> {
  try {
    const client = await getAcpClient();
    await client.lumina.schedulesDelete_unstable({ scheduleId });
    clearInFlightScheduleReads();
  } catch (error) {
...
export async function acpListScheduleSessions(
  ...
  const listPromise = (async () => {
    const client = await getAcpClient();
    const response = await client.lumina.schedulesSessionsList_unstable({ scheduleId, limit });
...
export async function acpRunScheduleNow(
  ...
  try {
    const client = await getAcpClient();
    const response = await client.lumina.schedulesRunNow_unstable({ scheduleId });
    clearInFlightScheduleReads();
    return response;
  } catch (error) {
...
export async function acpPauseSchedule(scheduleId: string): Promise<void> {
  try {
    const client = await getAcpClient();
    await client.lumina.schedulesPause_unstable({ scheduleId });
    clearInFlightScheduleReads();
  } catch (error) {
...
export async function acpUnpauseSchedule(scheduleId: string): Promise<void> {
  try {
    const client = await getAcpClient();
    await client.lumina.schedulesUnpause_unstable({ scheduleId });
    clearInFlightScheduleReads();
  } catch (error) {
...
export async function acpUpdateSchedule(
  ...
  try {
    const client = await getAcpClient();
    const response = await client.lumina.schedulesUpdate_unstable({ scheduleId, cron });
    clearInFlightScheduleReads();
    return response.job;
  } catch (error) {
...
export async function acpKillRunningJob(jobId: string): Promise<KillRunningJobResponse_unstable> {
  try {
    const client = await getAcpClient();
    const response = await client.lumina.schedulesRunningJobKill_unstable({ jobId });
    clearInFlightScheduleReads();
    return response;
  } catch (error) {
...
export async function acpInspectRunningJob(
  ...
  try {
    const client = await getAcpClient();
    return await client.lumina.schedulesRunningJobInspect_unstable({ jobId });
  } catch (error) {
