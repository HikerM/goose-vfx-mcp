...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Edit your Lumina configuration settings',
  },
  descriptionWithProvider: {
    id: 'configSettings.descriptionWithProvider',
    defaultMessage: 'Edit your Lumina configuration settings (current settings for {provider})',
  },
  editConfiguration: {
...
export default function ConfigSettings() {
  ...
  const currentProvider = typedConfig.LUMINA_PROVIDER || '';
