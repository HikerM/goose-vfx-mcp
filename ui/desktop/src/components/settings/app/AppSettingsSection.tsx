...
import ThemeSelector from '../../LuminaSidebar/ThemeSelector';
...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how Lumina appears on your system',
  },
  ...
  taskNotificationsDesc: {
    ...
    defaultMessage: 'Notify when Lumina finishes a task while the window is in the background',
  },
  menuBarIcon: { id: 'settings.menuBarIcon.title', defaultMessage: 'Menu bar icon' },
  menuBarIconDesc: {
    id: 'settings.menuBarIcon.description',
    defaultMessage: 'Show Lumina in the menu bar',
  },
  dockIcon: { id: 'settings.dockIcon.title', defaultMessage: 'Dock icon' },
  dockIconDesc: { id: 'settings.dockIcon.description', defaultMessage: 'Show Lumina in the dock' },
  preventSleep: { id: 'settings.preventSleep.title', defaultMessage: 'Prevent Sleep' },
  preventSleepDesc: {
    id: 'settings.preventSleep.description',
    defaultMessage:
      'Keep your computer awake while Lumina is running a task (screen can still lock)',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of Lumina',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for Lumina',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve Lumina by reporting issues or requesting new features',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select Lumina in the application list',
  },
      ...
      <Card className="rounded-lg">
        ...
        <CardContent className="pt-4 px-4">
          <div className="flex items-center gap-3">
            <LuminaLogo size="small" hover={false} />
            <span className="text-2xl font-mono text-black dark:text-white">
              {String(window.appConfig.get('LUMINA_VERSION') || 'Development')}
            </span>
          </div>
        </CardContent>
      </Card>
