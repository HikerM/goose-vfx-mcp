...
const i18n = defineMessages({
  ...
  noSkillsDescription: {
    ...
    defaultMessage:
      'Skills are loaded from SKILL.md files in ~/.config/agents/skills/, .lumina/skills/, or other supported directories.',
  },
  noMatchingSkills: {
  ...
  skillsDescription: {
    ...
    defaultMessage: 'View installed skills that extend Lumina capabilities. {shortcut} to search.',
  },
