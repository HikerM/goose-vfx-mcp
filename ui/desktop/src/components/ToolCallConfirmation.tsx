...
const i18n = defineMessages({
  ...
  luminaWouldLikeToCallWithName: {
    id: 'toolConfirmation.luminaWouldLikeToCallWithName',
    defaultMessage: 'Lumina would like to call {toolName}. Allow?',
  },
});
...
export default function ToolConfirmation({
  ...
  return (
    <div className="lumina-message-content bg-background-primary border border-border-primary rounded-2xl overflow-hidden">
      <div className="bg-background-secondary px-4 py-2 text-text-primary">
        {prompt
          ...
          : intl.formatMessage(i18n.luminaWouldLikeToCallWithName, { toolName: displayName })}
      </div>
      <ToolApprovalButtons
