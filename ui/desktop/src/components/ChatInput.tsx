...
export default function ChatInput({
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('lumina-queue-paused', JSON.stringify(queuePausedRef.current));
    } catch (error) {
  ...
  useEffect(() => {
    try {
      window.sessionStorage.setItem('lumina-queue-interruption', JSON.stringify(lastInterruption));
    } catch (error) {
