...
import type { LuminaDisplayMode, OnDisplayModeChange } from './types';
...
export interface DisplayModeState {
  activeDisplayMode: LuminaDisplayMode;
  ...
  changeDisplayMode: (mode: LuminaDisplayMode) => void;
...
export function useDisplayMode({
  ...
  const [activeDisplayMode, setActiveDisplayMode] = useState<LuminaDisplayMode>(displayMode);
