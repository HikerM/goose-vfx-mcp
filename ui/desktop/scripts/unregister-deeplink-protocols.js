...
/**
 * Script to unregister ALL lumina:// protocol handlers
...
function unregisterAllProtocolHandlers() {
  console.log('Unregistering ALL lumina:// protocol handlers...');
  
  try {
    // Get all registered Lumina apps
    console.log('Finding all registered Lumina applications...');
    ...
    if (pathMatches) {
      pathMatches.forEach(match => {
        ...
        if (path.includes('Lumina') || path.includes('lumina')) {
          uniquePaths.add(path);
        }
      });
    }
    
    console.log(`Found ${uniquePaths.size} Lumina app(s) to unregister:`);
    ...
    const bundleIds = [
      'io.github.hikerm.Lumina',
      'io.github.hikerm.Lumina.dev'
    ];
    ...
    console.log(`\n✅ Successfully processed ${unregisteredCount} Lumina applications`);
    console.log('All lumina:// protocol handlers have been unregistered.');
    ...
    console.log('1. Use Activity Monitor to quit all Lumina processes');
    console.log('2. Delete Lumina apps from Applications folder');
