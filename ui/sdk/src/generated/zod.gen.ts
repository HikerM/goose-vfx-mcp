 ...
 */
export const zLuminaToolCallRequest_unstable = z.object({
    sessionId: z.string(),
    name: z.string(),
 ...
 * Tool call response.
 */
export const zLuminaToolCallResponse_unstable = z.object({
...
export const zLuminaExtension = z.union([
    z.object({
        name: z.string(),
        description: z.union([
            z.string(),
...
export const zGetAvailableExtensionsResponse_unstable = z.object({
    extensions: z.array(zLuminaExtension)
});
...
export const zLuminaExtensionEntry = z.object({
    extension: zLuminaExtension,
    enabled: z.boolean(),
    configKey: z.union([
        z.string(),
...
export const zGetConfigExtensionsResponse_unstable = z.object({
    extensions: z.array(zLuminaExtensionEntry),
 ...
 */
export const zOnboardingImportSourceKind = z.enum(['lumina_config', 'claude_desktop']);
...
export const zProjectChangeSetGetRequest = z.object({
    runId: z.string(),
    baseRevision: z.union([
        z.string(),
        z.null()
    ]).optional()
});

export const zProjectChangeSetStatus = z.enum([
    'open',
    'conflict',
    'ready_for_review',
    'accepted',
...
export const zProjectChangeSetDto = z.object({
    id: z.string(),
    runId: z.string(),
    baseRevision: z.union([
        z.string(),
    ...
    status: zProjectChangeSetStatus,
    summary: z.string(),
    createdAtMs: z.number().int(),
    updatedAtMs: z.number().int()
});

export const zProjectChangeSetResponse = z.object({
    changeSet: zProjectChangeSetDto
});

export const zProjectListRequest = z.object({
    includeArchived: z.boolean().optional().default(false)
});

export const zProjectOpenRequest = z.object({
    rootPath: z.string(),
    name: z.union([
        z.string(),
        z.null()
...
export const zProjectProfileDto = z.object({
    manifests: z.array(z.string()).optional().default([]),
    detectedStacks: z.array(z.string()).optional().default([]),
...
export const zProjectDto = z.object({
    ...
    profile: zProjectProfileDto,
    createdAtMs: z.number().int(),
    updatedAtMs: z.number().int(),
    lastOpenedAtMs: z.number().int(),
    archivedAtMs: z.union([
        z.number().int(),
        z.null()
    ]).optional()
});
...
export const zProjectListResponse = z.object({
    projects: z.array(zProjectDto).optional().default([])
});

export const zProjectOpenResponse = z.object({
    project: zProjectDto
});

export const zProjectRunPhase = z.enum([
    'discovering',
    'planning',
    'awaiting_approval',
    'executing',
...
export const zProjectCheckpointCreateRequest = z.object({
    runId: z.string(),
    phase: zProjectRunPhase,
    state: z.unknown().optional().default(null),
    safeToResume: z.boolean()
});

export const zProjectCheckpointDto = z.object({
    id: z.string(),
    runId: z.string(),
...
export const zProjectCheckpointResponse = z.object({
    checkpoint: zProjectCheckpointDto
});

export const zProjectRunPhaseRequest = z.object({
    runId: z.string(),
    phase: zProjectRunPhase
});

export const zProjectRunStartRequest = z.object({
    workItemId: z.string(),
    sessionId: z.union([
        z.string(),
        z.null()
...
export const zProjectRunStatus = z.enum([
    'pending',
    'running',
    'succeeded',
    'failed',
...
export const zProjectRunDto = z.object({
    id: z.string(),
    workItemId: z.string(),
    sessionId: z.union([
        z.string(),
...
export const zProjectRunFinishRequest = z.object({
    runId: z.string(),
    status: zProjectRunStatus,
    errorCode: z.union([
        z.string(),
...
export const zProjectRunResponse = z.object({
    run: zProjectRunDto
});

export const zProjectRunStepStatus = z.enum([
    'pending',
    'running',
    'completed',
    'failed',
...
export const zProjectRunStepDto = z.object({
    id: z.string(),
    runId: z.string(),
    sequence: z.number().int(),
    kind: z.string(),
    title: z.string(),
    status: zProjectRunStepStatus,
    detail: z.unknown(),
    startedAtMs: z.union([
        z.number().int(),
        z.null()
...
export const zProjectSnapshotRequest = z.object({
    projectId: z.string()
});

export const zProjectWorkItemCompleteRequest = z.object({
    workItemId: z.string()
});

export const zProjectWorkItemCreateRequest = z.object({
    projectId: z.string(),
    title: z.string(),
    objective: z.string(),
...
export const zProjectWorkItemStatus = z.enum([
    'draft',
    'planned',
    'running',
    'validating',
...
export const zProjectWorkItemDto = z.object({
    id: z.string(),
    projectId: z.string(),
    title: z.string(),
    objective: z.string(),
    acceptanceCriteria: z.array(z.string()).optional().default([]),
    status: zProjectWorkItemStatus,
    createdAtMs: z.number().int(),
    updatedAtMs: z.number().int(),
...
export const zProjectSnapshotDto = z.object({
    project: zProjectDto,
    workItems: z.array(zProjectWorkItemDto).optional().default([]),
    runs: z.array(zProjectRunDto).optional().default([]),
    runSteps: z.array(zProjectRunStepDto).optional().default([]),
    checkpoints: z.array(zProjectCheckpointDto).optional().default([]),
    interruptedRunCount: z.number().int().gte(0)
});

export const zProjectSnapshotResponse = z.object({
    snapshot: zProjectSnapshotDto
});

export const zProjectWorkItemResponse = z.object({
    workItem: zProjectWorkItemDto
});
...
export const zRecipeSettingsDto = z.object({
    lumina_provider: z.union([
        z.string(),
        z.null()
    ]).optional(),
    lumina_model: z.union([
        z.string(),
        z.null()
    ]).optional(),
    temperature: z.union([
...
export const zSessionImportSource = z.enum(['auto', 'json']);
 ...
 */
export const zLuminaSessionUpdate = z.union([
    z.object({
 ...
 */
export const zLuminaSessionNotification_unstable = z.object({
    sessionId: z.string(),
    update: zLuminaSessionUpdate
});
