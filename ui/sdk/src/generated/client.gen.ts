...
import type {
  ...
  LuminaToolCallRequest_unstable,
  LuminaToolCallResponse_unstable,
  ...
  ProjectChangeSetGetRequest,
  ProjectChangeSetResponse,
  ...
  ProjectOpenRequest,
  ProjectOpenResponse,
  ProjectRunFinishRequest,
  ProjectRunPhaseRequest,
  ProjectRunResponse,
  ProjectRunStartRequest,
  ProjectSnapshotRequest,
  ProjectSnapshotResponse,
  ProjectWorkItemCompleteRequest,
...
import {
  ...
  zLuminaSessionNotification_unstable,
  zLuminaToolCallResponse_unstable,
  ...
  zProjectChangeSetResponse,
  zProjectCheckpointResponse,
  zProjectListResponse,
  zProjectOpenResponse,
  zProjectRunResponse,
  zProjectSnapshotResponse,
  zProjectWorkItemResponse,
...
export class LuminaExtClient {
  ...
  async sessionExtensionsAdd_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/session/extensions/add",
      params,
    );
  }
  ...
  async sessionExtensionsRemove_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/session/extensions/remove",
      params,
    );
  }
  ...
  async toolsPermissionsSet_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/tools/permissions/set",
      params,
    );
  ...
  async toolsCall_unstable(
    params: LuminaToolCallRequest_unstable,
  ): Promise<LuminaToolCallResponse_unstable> {
    const raw = await this.conn.extMethod(
      "_lumina/unstable/tools/call",
      params,
    );
    return zLuminaToolCallResponse_unstable.parse(
      raw,
    ) as LuminaToolCallResponse_unstable;
  }
  ...
  async resourcesRead_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/resources/read",
      params,
    );
  ...
  async appsList_unstable(
    ...
    const raw = await this.conn.extMethod("_lumina/unstable/apps/list", params);
  ...
  async sessionWorkingDirUpdate_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/session/working-dir/update",
      params,
    );
  }
  ...
  async sessionSystemPromptSet_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/session/system-prompt/set",
      params,
    );
  }
  ...
  async sessionSteer_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/session/steer",
      params,
    );
  ...
  async diagnosticsGet_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/diagnostics/get",
      params,
    );
  ...
  async configPromptsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/config/prompts/list",
      params,
    );
  ...
  async configPromptsGet_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/config/prompts/get",
      params,
    );
  ...
  async configPromptsSave_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/config/prompts/save",
      params,
    );
  ...
  async configPromptsReset_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/config/prompts/reset",
      params,
    );
    return zPromptOperationResponse_unstable.parse(
      raw,
  ...
  async configExtensionsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/config/extensions/list",
      params,
    );
  ...
  async extensionsAvailable_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/extensions/available",
      params,
    );
  ...
  async configExtensionsAdd_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/config/extensions/add", params);
  }
  ...
  async configExtensionsRemove_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/config/extensions/remove",
      params,
    );
  }
  ...
  async configExtensionsSetEnabled_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/config/extensions/set-enabled",
      params,
    );
  }
  ...
  async sessionExtensionsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/session/extensions/list",
      params,
    );
  ...
  async providersList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/list",
      params,
    );
  ...
  async providersSupportedModelsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/supported-models/list",
      params,
    );
  ...
  async providersCatalogList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/catalog/list",
      params,
    );
  ...
  async providersSetupCatalogList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/setup/catalog/list",
      params,
    );
  ...
  async providersCatalogTemplate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/catalog/template",
      params,
    );
  ...
  async providersCustomCreate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/custom/create",
      params,
    );
  ...
  async providersCustomRead_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/custom/read",
      params,
    );
  ...
  async providersCustomUpdate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/custom/update",
      params,
    );
  ...
  async providersCustomDelete_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/custom/delete",
      params,
    );
  ...
  async providersInventoryRefresh_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/inventory/refresh",
      params,
    );
  ...
  async providersConfigRead_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/config/read",
      params,
    );
  ...
  async providersConfigStatus_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/config/status",
      params,
    );
  ...
  async providersConfigSave_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/config/save",
      params,
    );
  ...
  async providersConfigDelete_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/config/delete",
      params,
    );
    return zProviderConfigChangeResponse_unstable.parse(
      raw,
  ...
  async providersConfigAuthenticate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/config/authenticate",
      params,
    );
    return zProviderConfigChangeResponse_unstable.parse(
      raw,
  ...
  async providersSecretsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/secrets/list",
      params,
    );
  ...
  async providersSecretsDelete_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/providers/secrets/delete",
      params,
    );
  }
  ...
  async providersCanonicalModelInfo_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/providers/canonical-model-info",
      params,
    );
  ...
  async preferencesRead_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/preferences/read",
      params,
    );
  ...
  async preferencesSave_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/preferences/save", params);
  }

  async preferencesRemove_unstable(
    params: PreferencesRemoveRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/preferences/remove", params);
  }
  ...
  async configUpsert_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/config/upsert", params);
  }

  async configRemove_unstable(
    params: ConfigRemoveRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/config/remove", params);
  }
  ...
  async configReadAll_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/config/read-all",
      params,
    );
  ...
  async defaultsRead_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/defaults/read",
      params,
    );
  ...
  async defaultsSave_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/defaults/save",
      params,
    );
    return zDefaultsReadResponse_unstable.parse(
      raw,
  ...
  async defaultsClear_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/defaults/clear",
      params,
    );
    return zDefaultsReadResponse_unstable.parse(
      raw,
  ...
  async onboardingImportScan_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/onboarding/import/scan",
      params,
    );
  ...
  async onboardingImportApply_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/onboarding/import/apply",
      params,
    );
  ...
  async sessionExport_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/session/export",
      params,
    );
  ...
  async sessionImport_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/session/import",
      params,
    );
  ...
  async recipesEncode_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/recipes/encode",
      params,
    );
  ...
  async recipesDecode_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/recipes/decode",
      params,
    );
  ...
  async recipesDelete_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/recipes/delete", params);
  }

  async recipesSchedule_unstable(
    params: ScheduleRecipeRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/recipes/schedule", params);
  }

  async recipesSlashCommand_unstable(
    params: SetRecipeSlashCommandRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/recipes/slash-command", params);
  }
  ...
  async recipesParse_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/recipes/parse",
      params,
    );
  ...
  async recipesToYaml_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/recipes/to-yaml",
      params,
    );
  ...
  async schedulesList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/list",
      params,
    );
  ...
  async schedulesSessionsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/sessions/list",
      params,
    );
  ...
  async schedulesCreate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/create",
      params,
    );
  ...
  async schedulesDelete_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/schedules/delete", params);
  }

  async schedulesPause_unstable(
    params: PauseScheduleRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/schedules/pause", params);
  }

  async schedulesUnpause_unstable(
    params: UnpauseScheduleRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/schedules/unpause", params);
  }
  ...
  async schedulesUpdate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/update",
      params,
    );
  ...
  async schedulesRunNow_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/run-now",
      params,
    );
  ...
  async schedulesRunningJobKill_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/running-job/kill",
      params,
    );
  ...
  async schedulesRunningJobInspect_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/schedules/running-job/inspect",
      params,
    );
  ...
  async sessionConversationTruncate_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/session/conversation/truncate",
      params,
    );
  }
  ...
  async sessionProjectUpdate_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/session/project/update",
      params,
    );
  }
  ...
  async sessionRename_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/session/rename", params);
  }

  async sessionArchive_unstable(
    params: ArchiveSessionRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/session/archive", params);
  }

  async sessionUnarchive_unstable(
    params: UnarchiveSessionRequest_unstable,
  ): Promise<void> {
    await this.conn.extMethod("_lumina/unstable/session/unarchive", params);
  }
  ...
  async sourcesCreate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/sources/create",
      params,
    );
  ...
  async agentMentionsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/agent-mentions/list",
      params,
    );
  ...
  async slashCommandsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/slash-commands/list",
      params,
    );
  ...
  async sourcesUpdate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/sources/update",
      params,
    );
  ...
  async sourcesDelete_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/sources/delete", params);
  }
  ...
  async sourcesExport_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/sources/export",
      params,
    );
  ...
  async sourcesImport_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/sources/import",
      params,
    );
  ...
  async dictationTranscribe_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/dictation/transcribe",
      params,
    );
  ...
  async dictationConfig_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/dictation/config",
      params,
    );
  ...
  async dictationSecretSave_unstable(
    ...
    await this.conn.extMethod("_lumina/unstable/dictation/secret/save", params);
  }
  ...
  async dictationSecretDelete_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/dictation/secret/delete",
      params,
    );
  }
  ...
  async dictationModelsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/dictation/models/list",
      params,
    );
  ...
  async dictationModelsDownload_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/dictation/models/download",
      params,
    );
  }
  ...
  async dictationModelsDownloadProgress_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/dictation/models/download/progress",
      params,
    );
  ...
  async dictationModelsCancel_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/dictation/models/cancel",
      params,
    );
  }
  ...
  async dictationModelsDelete_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/dictation/models/delete",
      params,
    );
  }
  ...
  async dictationModelsSelect_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/dictation/models/select",
      params,
    );
  }
  ...
  async localInferenceModelsList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/list",
      params,
    );
  ...
  async localInferenceModelsDownload_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/download",
      params,
    );
  ...
  async localInferenceModelsDownloadProgress_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/download/progress",
      params,
    );
  ...
  async localInferenceModelsDownloadCancel_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/download/cancel",
      params,
    );
  }
  ...
  async localInferenceModelsDelete_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/delete",
      params,
    );
  }
  ...
  async localInferenceModelsEvict_unstable(
    ...
    await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/evict",
      params,
    );
  }
  ...
  async localInferenceModelsSettingsRead_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/settings/read",
      params,
    );
  ...
  async localInferenceModelsSettingsUpdate_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/models/settings/update",
      params,
    );
  ...
  async localInferenceHuggingfaceSearch_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/huggingface/search",
      params,
    );
  ...
  async localInferenceHuggingfaceRepoVariants_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/huggingface/repo/variants",
      params,
    );
  ...
  async localInferenceChatTemplatesBuiltinList_unstable(
    ...
    const raw = await this.conn.extMethod(
      "_lumina/unstable/local-inference/chat-templates/builtin/list",
      params,
    );
  ...
  async luminaProjectOpen(
    params: ProjectOpenRequest,
  ): Promise<ProjectOpenResponse> {
    const raw = await this.conn.extMethod("_lumina/project/open", params);
    return zProjectOpenResponse.parse(raw) as ProjectOpenResponse;
  }

  async luminaProjectList(
    params: ProjectListRequest,
  ): Promise<ProjectListResponse> {
    const raw = await this.conn.extMethod("_lumina/project/list", params);
    return zProjectListResponse.parse(raw) as ProjectListResponse;
  }

  async luminaProjectSnapshot(
    params: ProjectSnapshotRequest,
  ): Promise<ProjectSnapshotResponse> {
    const raw = await this.conn.extMethod("_lumina/project/snapshot", params);
    return zProjectSnapshotResponse.parse(raw) as ProjectSnapshotResponse;
  }

  async luminaProjectWorkItemsCreate(
    params: ProjectWorkItemCreateRequest,
  ): Promise<ProjectWorkItemResponse> {
    const raw = await this.conn.extMethod(
      "_lumina/project/work-items/create",
      params,
    );
    return zProjectWorkItemResponse.parse(raw) as ProjectWorkItemResponse;
  }

  async luminaProjectWorkItemsComplete(
    params: ProjectWorkItemCompleteRequest,
  ): Promise<ProjectWorkItemResponse> {
    const raw = await this.conn.extMethod(
  ...
  async luminaProjectRunsStart(
    params: ProjectRunStartRequest,
  ): Promise<ProjectRunResponse> {
    const raw = await this.conn.extMethod("_lumina/project/runs/start", params);
    return zProjectRunResponse.parse(raw) as ProjectRunResponse;
  }

  async luminaProjectRunsPhase(
    params: ProjectRunPhaseRequest,
  ): Promise<ProjectRunResponse> {
    const raw = await this.conn.extMethod("_lumina/project/runs/phase", params);
    return zProjectRunResponse.parse(raw) as ProjectRunResponse;
  }

  async luminaProjectRunsFinish(
    params: ProjectRunFinishRequest,
  ): Promise<ProjectRunResponse> {
    const raw = await this.conn.extMethod(
      "_lumina/project/runs/finish",
      params,
    );
    return zProjectRunResponse.parse(raw) as ProjectRunResponse;
  }

  async luminaProjectCheckpointsCreate(
    params: ProjectCheckpointCreateRequest,
  ): Promise<ProjectCheckpointResponse> {
    const raw = await this.conn.extMethod(
      "_lumina/project/checkpoints/create",
      params,
    );
    return zProjectCheckpointResponse.parse(raw) as ProjectCheckpointResponse;
  }

  async luminaProjectChangeSetsGet(
    params: ProjectChangeSetGetRequest,
  ): Promise<ProjectChangeSetResponse> {
    const raw = await this.conn.extMethod(
      "_lumina/project/change-sets/get",
      params,
    );
    return zProjectChangeSetResponse.parse(raw) as ProjectChangeSetResponse;
  }
}

export interface LuminaExtNotifications {
  unstable_sessionUpdate?: (
    notification: LuminaSessionNotification_unstable,
  ) => Promise<void>;
}

export interface LuminaExtAgentRequests {
  unstable_sessionRecipeRequestParams?: (
    request: RequestRecipeParams_unstable,
  ) => Promise<RecipeParamsResponse_unstable>;
}

export type LuminaClientCallbacks = Omit<
  Client,
...
export function installLuminaExtNotificationDispatcher(
  callbacks: LuminaClientCallbacks,
): Client {
  const dispatcher: Pick<Client, "extNotification"> = {
    extNotification: async (method, params) => {
      switch (method) {
        case "_lumina/unstable/session/update": {
          const parsed = zLuminaSessionNotification_unstable.parse(
            params,
          ) as LuminaSessionNotification_unstable;
...
export function installLuminaExtAgentRequestDispatcher(
  callbacks: LuminaClientCallbacks,
): Client {
  const dispatcher: Pick<Client, "extMethod"> = {
    extMethod: async (method, params) => {
      switch (method) {
        case "_lumina/unstable/session/recipe/request-params": {
