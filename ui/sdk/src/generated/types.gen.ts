...
export type GetAvailableExtensionsResponse_unstable = {
    extensions: Array<LuminaExtension>;
};
...
export type GetConfigExtensionsResponse_unstable = {
    extensions: Array<LuminaExtensionEntry>;
...
export type LuminaExtensionEntry = {
    extension: LuminaExtension;
    enabled: boolean;
    configKey?: string | null;
};
 ...
 */
export type LuminaSessionNotification_unstable = {
    sessionId: string;
    update: LuminaSessionUpdate;
};
 ...
 */
export type LuminaSessionUpdate = ({
 ...
 */
export type LuminaToolCallRequest_unstable = {
    sessionId: string;
    name: string;
    arguments?: unknown;
};
 ...
 * Tool call response.
 */
export type LuminaToolCallResponse_unstable = {
 ...
 */
export type OnboardingImportSourceKind = 'lumina_config' | 'claude_desktop';
...
export type PreferenceKey = 'autoCompactThreshold' | 'luminaThinkingEffort' | 'voiceAutoSubmitPhrases' | 'voiceDictationProvider' | 'voiceDictationPreferredMic';
...
export type ProjectChangeSetDto = {
    id: string;
    runId: string;
...
export type ProjectChangeSetGetRequest = {
    runId: string;
    baseRevision?: string | null;
};

export type ProjectChangeSetResponse = {
    changeSet: ProjectChangeSetDto;
};

export type ProjectChangeSetStatus = 'open' | 'conflict' | 'ready_for_review' | 'accepted' | 'reverted';

export type ProjectCheckpointCreateRequest = {
    runId: string;
...
export type ProjectCheckpointDto = {
    id: string;
    runId: string;
    sequence: number;
    phase: ProjectRunPhase;
...
export type ProjectCheckpointResponse = {
    checkpoint: ProjectCheckpointDto;
};
...
export type ProjectRunFinishRequest = {
    runId: string;
    status: ProjectRunStatus;
    errorCode?: string | null;
    errorMessage?: string | null;
...
export type ProjectRunPhase = 'discovering' | 'planning' | 'awaiting_approval' | 'executing' | 'validating' | 'reviewing' | 'complete';

export type ProjectRunPhaseRequest = {
    runId: string;
    phase: ProjectRunPhase;
};
...
export type ProjectRunStartRequest = {
    workItemId: string;
    sessionId?: string | null;
};

export type ProjectRunStatus = 'pending' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'interrupted';

export type ProjectRunStepDto = {
    id: string;
    runId: string;
    sequence: number;
    kind: string;
...
export type ProjectRunStepStatus = 'pending' | 'running' | 'completed' | 'failed' | 'skipped';

export type ProjectSnapshotDto = {
    project: ProjectDto;
    workItems?: Array<ProjectWorkItemDto>;
    runs?: Array<ProjectRunDto>;
    runSteps?: Array<ProjectRunStepDto>;
    checkpoints?: Array<ProjectCheckpointDto>;
...
export type ProjectWorkItemCompleteRequest = {
    workItemId: string;
};

export type ProjectWorkItemCreateRequest = {
    projectId: string;
    title: string;
    objective: string;
...
export type ProjectWorkItemResponse = {
    workItem: ProjectWorkItemDto;
};

export type ProjectWorkItemStatus = 'draft' | 'planned' | 'running' | 'validating' | 'review' | 'completed' | 'failed' | 'cancelled' | 'interrupted' | 'blocked';
...
export type RecipeSettingsDto = {
    lumina_provider?: string | null;
    lumina_model?: string | null;
...
export type SessionImportSource = 'auto' | 'json';
