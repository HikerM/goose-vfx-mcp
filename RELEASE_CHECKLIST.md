# lumina Release Manual Testing Checklist
...
## Run the lumina self-test recipe

lumina run --recipe lumina-self-test.yaml

## Have lumina produce a test plan

Open the release candidate desktop app and have lumina produce a test plan by pointing it at this PR. Use a prompt like
...
lumina will produce a plan. Follow this plan to finish testing.
