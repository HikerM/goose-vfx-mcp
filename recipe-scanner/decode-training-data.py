...
def write_training_files(training_data, output_dir="/tmp/training"):
    """
    Write decoded training files to disk for Lumina to analyze
    """
    output_path = Path(output_dir)
    output_path.mkdir(exist_ok=True)
    
    # Write a summary file for Lumina
    summary = {
...
def create_lumina_instructions(training_data, output_file="/tmp/lumina_training_instructions.md"):
    """
    Create instructions for Lumina based on the training data
    """
    instructions = [
    ...
    print(f"📋 Lumina instructions written to: {output_file}")
    return output_file
...
if __name__ == "__main__":
    ...
    if training_data:
        ...
        instructions_file = create_lumina_instructions(training_data)
