...
mod imp {
    ...
    fn invalid_initialize_protocol_version() -> crate::Error {
        crate::Error::invalid_params().data("invalid_protocol_version")
    }
    ...
    fn unsupported_protocol_version(_version: ProtocolVersion) -> crate::Error {
        crate::Error::invalid_request().data("unsupported_protocol_version")
    }
    ...
    fn required_protocol_version(
        ...
        let _ = (required, negotiated);
        crate::Error::invalid_request().data("protocol_version_mismatch")
    }
