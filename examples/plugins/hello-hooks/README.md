...
A tiny [Open Plugins](https://open-plugins.com) plugin that demonstrates lumina's
...
Lumina discovers plugins under `~/.agents/plugins/<name>/` (user scope) and
...
# Then run lumina normally; you should see lines like
