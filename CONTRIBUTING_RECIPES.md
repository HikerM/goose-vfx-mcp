# 🍳 Contributing Recipes to lumina Cookbook

Thank you for your interest in contributing to the lumina Recipe Cookbook! This guide will walk you through the process of submitting your own recipe.

## 🚀 Quick Start

1. [Fork this repository](https://github.com/HikerM/lumina/fork)
...
📚 **Need help with the format?** Check out the [Recipe Reference Guide](https://hikerm.github.io/lumina/docs/guides/recipes/recipe-reference) or [existing recipes](documentation/src/pages/recipes/data/recipes/) for examples.
...
- [ ] **Follow the format** - Refer to the [Recipe Reference Guide](https://hikerm.github.io/lumina/docs/guides/recipes/recipe-reference)
...
- 📚 **Check the docs** at [hikerm.github.io/lumina](https://hikerm.github.io/lumina/docs/guides/recipes/)
...
**Ready to contribute?** [Fork the repo](https://github.com/HikerM/lumina/fork) and start creating!

*Questions? Ask in your PR or hop into [discord](https://discord.gg/lumina-oss) - we're here to help!* 💙
