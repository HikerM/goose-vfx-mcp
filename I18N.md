# Internationalization (i18n) — Lumina Desktop UI

This document describes the i18n infrastructure for the Lumina Desktop UI (`ui/desktop/`).
...
2. **`LUMINA_LOCALE`** — explicit override from env/app config when the desktop setting is
   System Default
