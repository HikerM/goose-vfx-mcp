...
# ///
"""Harbor benchmark runner and reporter for Lumina.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_run.add_argument("lumina_binary", type=Path, help="path to the lumina binary to test")
    ...
    p_run.add_argument(
        "--no-install-lumina-runtime-deps",
        dest="install_lumina_runtime_deps",
        action="store_false",
        default=True,
    ...
    p_pull.add_argument(
        "remote",
        help="user@host:/path/to/lumina (we append evals/harbor/runs/)",
    )
    p_pull.add_argument(
        "--jobs",
        nargs="*",
