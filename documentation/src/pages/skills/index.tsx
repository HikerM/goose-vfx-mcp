...
export default function SkillsPage() {
  ...
  Object.entries(selectedFilters).forEach(([group, values]) => {
    if (values.length > 0) {
      filteredSkills = filteredSkills.filter((skill) => {
        ...
        if (group === "Source") {
          // Use isCommunity field from manifest (true if author is not "lumina")
  ...
  return (
    <Layout
      ...
      description="Browse and install community-contributed skills for lumina"
    >
      <div className="container mx-auto px-4 py-8 md:p-24">
        <div className="pb-8 md:pb-16">
          ...
          <p className="text-textProminent">
            ...
            that teach lumina how to perform specific tasks. Skills are reusable
