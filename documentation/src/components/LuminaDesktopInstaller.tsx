...
interface LuminaDesktopInstallerProps {
  extensionId: string;
...
export default function LuminaDesktopInstaller({
  extensionId,
  extensionName,
  description,
  type,
  ...
  const buildLuminaUrl = () => {
    ...
    return `lumina://extension?${urlParts.join('&')}`;
  };
  ...
  return (
    <div>
      <ol>
        <li>
          <a href={buildLuminaUrl()}>Launch the installer</a>
        </li>
