---
description: Integrate lumina with Langfuse to observe performance
---

# Observability with Langfuse

This tutorial covers how to integrate lumina with Langfuse to monitor your lumina requests and understand how the agent is performing.
...
## Configure lumina to Connect to Langfuse

Set the environment variables so that lumina (written in Rust) can connect to the Langfuse server.
...
## Run lumina with Langfuse Integration

Now, you can run lumina and monitor your AI requests and actions through Langfuse.

With lumina running and the environment variables set, Langfuse will start capturing traces of your lumina activities.
...
![lumina trace in Langfuse](https://langfuse.com//images/docs/lumina-integration/lumina-example-trace.png)
