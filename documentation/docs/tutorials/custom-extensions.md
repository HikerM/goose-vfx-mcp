...
description: Create your own custom MCP Server to use as a lumina extension
---
...
:::info
lumina supports Tools, Resources, and Prompts from the [Model Context Protocol](https://modelcontextprotocol.io/). See [`mcp_client.rs`](https://github.com/HikerM/lumina/blob/main/crates/lumina/src/agents/mcp_client.rs) for the supported protocol version and client capabilities.
:::
...
## Step 5: Integrate with lumina

To add your MCP server as an extension in lumina:
...
2. Open lumina Desktop and click the <PanelLeft className="inline" size={16} /> button in the top-left to open the sidebar
...
To see any changes you make to your MCP server code after integrating with lumina, re-run `uv pip install .` and then restart lumina Desktop.
:::
...
## Step 6: Use Your Extension in lumina

Once integrated, you can start using your extension in lumina. Open the lumina chat interface and call your tool as needed.

You can verify that lumina has picked up the tools from your custom extension by asking it "what tools do you have?"

![lumina Chat - Ask about tools](../assets/guides/custom-extension-tools.png)

Then, you can try asking questions that require using the extension you added.

![lumina Chat - Use custom extension](../assets/guides/custom-extension-chat.png)

🎉 **Congratulations!** You’ve successfully built and integrated a custom MCP server with lumina.

---

## Advanced Features for MCP Extensions

lumina supports advanced MCP features that can enhance your extensions.

### MCP Sampling: AI-Powered Tools

**[MCP Sampling](/docs/guides/mcp-sampling)** allows your MCP servers to request AI completions from lumina's LLM, transforming simple tools into intelligent agents.
...
- [lumina's implementation](https://github.com/HikerM/lumina/blob/main/crates/lumina/src/agents/mcp_client.rs) currently supports text and image content types
- lumina automatically advertises sampling capability to all MCP servers
...
- Components render securely in isolated sandboxes within lumina Desktop
