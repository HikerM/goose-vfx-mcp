...
description: Add Asana MCP Server as a lumina Extension
---
...
This tutorial covers how to add the [Asana MCP Server](https://github.com/roychri/mcp-server-asana) as a lumina extension to enable task automation, project tracking, and team collaboration.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
  [Launch the installer](lumina://extension?cmd=npx&arg=-y&arg=%40roychri%2Fmcp-server-asana&id=asana&name=Asana&description=enable%20task%20automation%2C%20project%20tracking%2C%20and%20team%20collaboration&env=ASANA_ACCESS_TOKEN%3DAsana%20Access%20Token)
  </TabItem>
...
> _lumina, I have one hour. Look through uncompleted tasks assigned to me in Asana and show me ones that you estimate will take an hour or less. Order them by deadline._
