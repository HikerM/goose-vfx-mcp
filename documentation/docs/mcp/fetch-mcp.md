...
description: Add Fetch MCP Server as a lumina Extension
---
...
The Fetch extension [does not work](https://github.com/HikerM/lumina/issues/1184) with Google models (e.g. gemini-2.0-flash) because this extension uses `format: uri` in its JSON schema which Google doesn't support.
:::

This tutorial covers how to add the [Fetch MCP Server](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch) as a lumina extension to retrieve and process content from the web.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
  [Launch the installer](lumina://extension?cmd=uvx&arg=mcp-server-fetch&id=fetch&name=Fetch&description=Web%20content%20fetching%20and%20processing%20capabilities)
  </TabItem>
...
![website lumina built](../assets/guides/programmer-jokes-fetch-mcp.png)
