...
description: Add {Extension Name} MCP Server as a lumina Extension
---
...
This tutorial covers how to add the [{Extension Name} MCP Server](/) as a lumina extension to enable ________________.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
  [Launch the installer]({lumina_url})
  </TabItem>
