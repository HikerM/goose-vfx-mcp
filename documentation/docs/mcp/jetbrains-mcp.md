...
description: Use JetBrains MCP Server as a lumina Extension
---
...
This tutorial covers how to add the JetBrains extension to integrate with any JetBrains IDE. While lumina can use the [Developer extension](/docs/mcp/developer-mcp) for developer-centric tasks, the JetBrains extension provides a more integrated and project-aware way to work with code.
...
<Tabs groupId="ideVersion">
  <TabItem value="2026.1" label="2026.1 and later" default>
    ...
    <Tabs groupId="interface">
      ...
      Use `lumina configure` with the URL from `Copy HTTP Stream Config` in your IDE.
      </TabItem>
    </Tabs>
    :::
    ...
    2. Add the JetBrains extension to lumina using the URL from the config:
       ...
       <Tabs groupId="interface">
         <TabItem value="ui" label="lumina Desktop" default>
           ...
           4. On the `Add custom extension` modal, enter the following:
              ...
              - **Description**: Integrate lumina with any JetBrains IDE
  ...
  <TabItem value="2025.2" label="2025.2 – 2025.x">
    ...
    <Tabs groupId="interface">
      ...
      <TabItem value="cli" label="lumina CLI">
      Use `lumina configure` with the command from `Copy Stdio Config` in your IDE.
      </TabItem>
    </Tabs>
    :::
    ...
    2. Add the JetBrains extension to lumina using the command from the config:
...
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
   ...
   2. Open a new session in lumina Desktop
   :::note
   You will interact with two separate apps: the lumina Desktop app and the IntelliJ IDE.
   :::
  ...
  1. Open [IntelliJ](https://www.jetbrains.com/idea/download) (JetBrains' Java and Kotlin IDE)
  2. Open a terminal within your IDE and start a new lumina session:
...
:::tip
When using lumina to refactor code, it's recommended to commit your code to version control _before_ making changes. This way, you have a clean snapshot to compare against, making it easy to review lumina's modifications, revert if needed, and track improvements.
:::
...
After 2 minutes, lumina was done with the upgrade! 🎉
...
Using the JetBrains extension provided several advantages and made it easier for lumina to:
