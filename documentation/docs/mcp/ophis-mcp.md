...
description: Add Ophis as a lumina Extension to swap tokens with natural-language intents
---
...
This tutorial covers how to add [Ophis](https://ophis.fi) as a lumina extension so lumina can turn natural-language swap requests into executable orders across supported chains.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
    [Launch the installer](lumina://extension?type=streamable_http&url=https%3A%2F%2Fmcp.ophis.fi%2Fmcp&id=ophis&name=Ophis&description=Natural-language%20intent%20DEX%20aggregator%20with%20a%20keyless%20MCP%20server%20for%20AI%20agents)
  </TabItem>
  <TabItem value="cli" label="lumina CLI">
    Use `lumina configure` to add a `Remote Extension (Streamable HTTP)` extension type with:
...
Once Ophis is configured, you can describe a swap in plain language and ask lumina to prepare an order. Here are some examples:
