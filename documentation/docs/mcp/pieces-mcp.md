...
description: Add Pieces for Developers MCP Server as a lumina Extension
---
...
This tutorial covers how to add the [Pieces for Developers MCP Server](https://docs.pieces.app/products/mcp/get-started?utm_source=lumina&utm_medium=collab&utm_campaign=mcp) as a lumina extension to enable interaction with your Pieces Long-Term Memory.
...
1. Code Development with lumina:

    Activity: You worked on integrating MCP servers into the lumina CLI, making enhancements to handle extensions via schema URLs.
    Description: This task involved modifying code and testing new integrations to support advanced functionalities. It also included interactions with the lumina community in the issue tracker for feedback and troubleshooting.

2. Documentation Updates:

    Activity: You updated and managed documentation related to the lumina project and MCP integrations.
...
3. Community Interaction in the issue tracker:

  Activity: Engaged with the Lumina project issue tracker to discuss project developments and potential collaborations.
...
4. Managing and Testing Extensions:
    ...
    Activity: You focused on testing and managing various extensions through the lumina platform.
...
:::tip
For more examples of prompts you can use with the Pieces for Developers MCP Server, see the [Pieces MCP prompting guide](https://docs.pieces.app/products/mcp/prompting?utm_source=lumina&utm_medium=collab&utm_campaign=mcp).
:::
