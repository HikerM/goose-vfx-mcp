---
title: lumina Docs Extension

description: Add lumina Docs MCP Server as a lumina Extension
---
...
This tutorial covers how to add the [lumina Docs MCP Server](https://github.com/idosal/git-mcp) as a lumina extension to enable lumina to answer questions about itself.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
  [Launch the installer](lumina://extension?cmd=npx&arg=mcp-remote&arg=https%3A%2F%2Fblock.gitmcp.io%2Flumina%2F&id=lumina-docs&name=lumina%20Docs&description=gitmcp%20for%20lumina%20documentation)
  </TabItem>
  <TabItem value="cli" label="lumina CLI">
  **Command**
  ```sh
  npx mcp-remote https://block.gitmcp.io/lumina/
  ```
  </TabItem>
</Tabs>
:::
...
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
    <LuminaDesktopInstaller
      extensionId="lumina-docs"
      extensionName="lumina Docs"
      description="GitMCP for lumina documentation"
      command="npx"
      args={["mcp-remote", "https://block.gitmcp.io/lumina/"]}
      cliCommand="npx mcp-remote https://block.gitmcp.io/lumina/"
      timeout={300}
  ...
  <TabItem value="cli" label="lumina CLI">
      <CLIExtensionInstructions
        name="lumina Docs"
        description="GitMCP for lumina documentation"
        command="npx mcp-remote https://block.gitmcp.io/lumina/"
        timeout={300}
      />
  </TabItem>
</Tabs>
...
## Example Usage
GitMCP allows you to convert any Git repository into a lumina extension. The lumina Docs MCP Server is a great example of this, as it provides a way for lumina to answer questions about itself.

Let's ask lumina to create a recipe for us! It will use the lumina Docs MCP Server to find the relevant information.


### lumina Prompt

```
hey lumina, I want to create a recipe for automated code review that my development team can use. Can you look at the lumina documentation to understand the recipe format, then create a recipe that:
...
Please research the recipe format first using the lumina Docs extension, then create a complete recipe file with proper YAML structure, parameters, and any needed extensions.
...
Perfect! I've created a comprehensive automated code review recipe based on the lumina documentation research. Here's what I've built for your development team:
...
#### Basic Usage:
```bash
lumina run automated-code-review.yaml \
...
- Proper YAML structure following lumina recipe format
    ...
    properties:
      ...
      ci_cd_metadata:
        ...
        properties:
          ...
          reviewer:
            type: string
            description: "lumina automated code review"
          language:
            type: string
