...
description: Add Dev.to MCP Server as a lumina Extension
---
...
This tutorial covers how to add the [Dev.to MCP Server](https://github.com/nickytonline/dev-to-mcp) as a lumina extension to enable access to the Dev.to public API. With this extension, lumina can fetch articles, tags, user info, comments, and more—without requiring authentication.

:::tip Quick Install
<Tabs groupId="interface">
  <TabItem value="ui" label="lumina Desktop" default>
  [Launch the installer](lumina://extension?type=streamable_http&url=http%3A%2F%2Flocalhost%3A3000%2Fmcp&id=dev-to&name=Dev.to&description=Access%20Dev.to%20articles%20and%20content)
  </TabItem>
...
In this example, lumina uses the `Dev.to MCP` extension to fetch the 5 most recent JavaScript articles and instantly turn them into a personalized learning hub.

### lumina Prompt
```
Hey lumina, fetch the 5 most recent JavaScript articles from Dev.to
