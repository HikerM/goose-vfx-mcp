...
description: Mobile access via secure tunneling is no longer available in lumina Desktop.
unlisted: true
---

Mobile access via secure tunneling is no longer available in current lumina Desktop builds.
