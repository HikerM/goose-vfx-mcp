...
**Decision:** Package adapters use per-user lumina-managed runtimes/stores and platform-specific effect adapters. No global npm/pip install, system Python mutation, hard-coded OS data path, or implicit elevation is part of this architecture.
