...
| ARC-06 | MCP platform DB/install/cache paths derive from `Paths`, live under data storage, and are separate from sessions. | Path tests with `GOOSE_PATH_ROOT`; DB inventory check |
