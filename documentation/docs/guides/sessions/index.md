...
hide_title: true
description: Manage your session lifecycle and ongoing interactions with lumina
---
...
<p className={styles.pageDescription}>
  Sessions are your continuous interactions with lumina. Each session maintains context and conversation history, enabling lumina to understand your ongoing work and provide relevant assistance.
</p>
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    ...
    <Card 
      ...
      description="Discover features you can use to share information and communicate with lumina during sessions."
...
<div className={styles.categorySection}>
  ...
  <div className={styles.cardGrid}>
    <Card
      title="6 Essential Tips for Working with lumina"
      ...
      link="/blog/2025/03/06/lumina-tips"
    />
    <Card
    ...
    <Card
      ...
      description="Learn how context windows, tokens, and lumina help you manage memory and long conversations."
