...
The adversary uses the same model and provider lumina is already configured with. No additional API keys or services needed.

## Enabling Adversary Mode

Create a file at `~/.config/lumina/adversary.md` with your rules:
