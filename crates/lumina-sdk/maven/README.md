# Lumina SDK Maven package

This project packages the UniFFI-generated Kotlin/JVM bindings for `lumina-sdk`
as the Maven artifact `io.github.hikerm:gdk`.

The artifact version is read from `crates/lumina-sdk/Cargo.toml`, so it stays in
...
```bash
just --justfile crates/lumina-sdk/justfile maven-publish
```
