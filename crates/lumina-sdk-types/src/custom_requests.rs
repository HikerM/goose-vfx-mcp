...
#[request(method = "_lumina/unstable/session/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
pub struct AddSessionExtensionRequest {
    pub session_id: String,
    pub extension: LuminaExtension,
}

/// Remove an extension from an active session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/tools/list", response = GetToolsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/resources/read", response = ReadResourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/tools/call", response = LuminaToolCallResponse)]
#[serde(rename_all = "camelCase")]
pub struct LuminaToolCallRequest {
    pub session_id: String,
    pub name: String,
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcResponse)]
#[serde(rename_all = "camelCase")]
pub struct LuminaToolCallResponse {
    #[serde(default)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/apps/list", response = AppsListResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/apps/export", response = AppsExportResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/apps/import", response = AppsImportResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/apps/delete", response = AppsDeleteResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/working-dir/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
pub enum SessionSystemPromptMode {
    /// Replace Lumina's base system prompt with the provided text.
    Set,
    /// Append the provided text under Lumina's "Additional Instructions" section.
    #[default]
    Append,
}
...
///
/// `mode: "set"` replaces Lumina's base system prompt. `mode: "append"` adds an
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/session/system-prompt/set",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/session/steer",
...
pub struct SteerSessionResponse {
    ...
    /// `messageId` on the streamed `UserMessageChunk` (with `_meta.lumina.steer`),
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/diagnostics/get",
...
/// List all available Lumina prompt templates.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/prompts/list", response = ListPromptsResponse)]
#[serde(rename_all = "camelCase")]
...
/// Read a Lumina prompt template.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/prompts/get", response = GetPromptResponse)]
#[serde(rename_all = "camelCase")]
...
/// Save a custom Lumina prompt template.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/prompts/save", response = PromptOperationResponse)]
#[serde(rename_all = "camelCase")]
...
/// Reset a Lumina prompt template to its default content.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/prompts/reset", response = PromptOperationResponse)]
#[serde(rename_all = "camelCase")]
...
impl Default for LuminaExtension {
    fn default() -> Self {
        Self::Builtin {
            name: String::new(),
            description: None,
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
pub struct LuminaExtensionEntry {
    pub extension: LuminaExtension,
    pub enabled: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// List Lumina-owned extension definitions available to configure or enable.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/extensions/available",
...
pub struct GetAvailableExtensionsResponse {
    pub extensions: Vec<LuminaExtension>,
}

/// List configured extensions and any warnings.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/config/extensions/list",
...
pub struct GetConfigExtensionsResponse {
    pub extensions: Vec<LuminaExtensionEntry>,
    #[serde(default)]
...
/// Persist a new extension to the user's global lumina config.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/extensions/add", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
/// Remove a persisted extension from the user's global lumina config.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/extensions/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
pub struct RemoveConfigExtensionRequest {
    pub config_key: String,
}

/// Set the `enabled` flag for a persisted extension in the user's global lumina config.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/config/extensions/set-enabled",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/extensions/list", response = GetSessionExtensionsResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/preferences/read", response = PreferencesReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/preferences/save", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/preferences/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/read", response = ConfigReadResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/upsert", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/remove", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/config/read-all", response = ConfigReadAllResponse)]
#[serde(rename_all = "camelCase")]
...
/// Read Lumina default provider and model configuration.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/defaults/read", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
/// Save Lumina default provider and model configuration.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/defaults/save", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
/// Clear Lumina default provider and model configuration.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/defaults/clear", response = DefaultsReadResponse)]
#[serde(rename_all = "camelCase")]
...
/// Scan for existing Lumina and compatible app data that onboarding can import.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/onboarding/import/scan",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/onboarding/import/apply",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/secret/save", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/secret/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/session/info",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/session/conversation/truncate",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/project/update", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
/// Rename a session.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/rename", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/archive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/unarchive", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/export", response = ExportSessionResponse)]
#[serde(rename_all = "camelCase")]
pub struct ExportSessionRequest {
    pub session_id: String,
}

/// Export session response — raw JSON of the lumina session with `conversation`.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/session/import", response = ImportSessionResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/config/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/config/status",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/config/save",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/config/delete",
    response = ProviderConfigChangeResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/config/authenticate",
    response = ProviderConfigChangeResponse
)]
#[serde(rename_all = "camelCase")]
...
/// List provider credentials stored locally by Lumina.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/secrets/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/secrets/delete",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/canonical-model-info",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/catalog/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/setup/catalog/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/catalog/template",
...
/// Create a custom provider backed by Lumina's declarative provider store.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/custom/create",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/custom/read",
...
/// Update a custom provider backed by Lumina's declarative provider store.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/custom/update",
...
/// Delete a custom provider from Lumina's declarative provider store.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/custom/delete",
...
/// A source discovered by Lumina. Filesystem sources use an on-disk path;
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/sources/create", response = CreateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
/// skills.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/sources/list", response = ListSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/agent-mentions/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/slash-commands/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/sources/update", response = UpdateSourceResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/sources/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/sources/export", response = ExportSourceResponse)]
#[serde(rename_all = "camelCase")]
...
/// Import a source from a JSON export payload produced by `_lumina/unstable/sources/export`.
/// The imported source is written into the explicit target scope; on name
/// collisions a `-imported` suffix is appended.
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/sources/import", response = ImportSourcesResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/transcribe", response = DictationTranscribeResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/config", response = DictationConfigResponse)]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/providers/list", response = ListProvidersResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/supported-models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/providers/inventory/refresh",
...
pub struct ProviderInventoryEntryDto {
    ...
    /// Whether Lumina has enough configuration to use this provider.
    pub configured: bool,
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/download",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/download/progress",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/download/cancel",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/delete",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/evict",
    response = EmptyResponse
)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/settings/read",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/models/settings/update",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/huggingface/search",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/huggingface/repo/variants",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/local-inference/chat-templates/builtin/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/dictation/models/list",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/models/download", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(
    method = "_lumina/unstable/dictation/models/download/progress",
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/models/cancel", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/models/delete", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/dictation/models/select", response = EmptyResponse)]
#[serde(rename_all = "camelCase")]
...
#[derive(Debug, Default, Clone, Serialize, Deserialize, JsonSchema, JsonRpcRequest)]
#[request(method = "_lumina/unstable/tools/permissions/set", response = SetToolPermissionsResponse)]
#[serde(rename_all = "camelCase")]
