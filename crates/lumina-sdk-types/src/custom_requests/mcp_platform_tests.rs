...
fn https_provision_response_is_a_closed_safe_projection() {
    ...
    assert!(!review.default_disabled);
    ...
    assert!(enabled_review.default_disabled);
...
fn source_adapter_descriptor_constructor_is_the_external_construction_boundary() {
    ...
    // rejected for callers outside lumina_sdk_types; they must use the validated constructor.
