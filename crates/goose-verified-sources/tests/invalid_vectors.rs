...
use goose_verified_sources::{parse_and_verify_envelope, verify_chain, ErrorCode, State};
...
fn valid_with_replaced_kid(
    root_key: &goose_verified_sources::RootKey,
...
fn canonical_text(envelope: goose_verified_sources::Envelope) -> String {
