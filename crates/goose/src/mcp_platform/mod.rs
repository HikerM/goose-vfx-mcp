...
//!
//! ```compile_fail
//! use goose::mcp_platform::{McpProfile, ProfileApplyConfirmationView};
//!
//! let _profile = McpProfile {
//!     profile_id: "profile".to_string(),
//!     name: "Example".to_string(),
...
//!     confirmation_token: "profile_apply_confirmation_token".to_string(),
//! };
//! let _ = goose::mcp_platform::extension_source_fingerprint;
//! let _: goose::mcp_platform::profile::StoredProfileApplyPlan;
//! ```
//!
//! ```compile_fail
//! use goose::mcp_platform::{
