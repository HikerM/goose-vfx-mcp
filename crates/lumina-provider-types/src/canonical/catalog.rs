...
const SETUP_METADATA: &[CuratedSetupMetadata] = &[
    ...
    CuratedSetupMetadata {
        ...
        docs_url: Some("https://docs.z.ai/devpack/tool/lumina"),
        aliases: &["z.ai", "zhipu"],
        native_connect_query: None,
        binary_name: None,
        setup_capabilities: setup_capabilities(false, false, false),
...
fn synthetic_lumina_setup_entry(curated: &CuratedSetupMetadata) -> ProviderSetupCatalogEntry {
    ProviderSetupCatalogEntry {
        provider_id: curated.provider_id.to_string(),
        display_name: curated.display_name.unwrap_or("Lumina").to_string(),
        category: ProviderSetupCategory::Agent,
    ...
    SETUP_METADATA
        ...
        .filter_map(|curated| {
            if curated.synthetic {
                return Some(synthetic_lumina_setup_entry(curated));
            }
