...
//!   cargo test -p lumina --test local_inference_perf -- --ignored --nocapture
//!
//! Run with a specific model:
//!   TEST_MODEL="bartowski/Qwen_Qwen3-32B-GGUF:Q4_K_M" cargo test -p lumina --test local_inference_perf -- --ignored --nocapture
...
async fn test_local_inference_cold_vs_warm() {
    ...
    let messages = vec![lumina::conversation::message::Message::user().with_text("What is 2+2?")];
    ...
    let messages2 = vec![lumina::conversation::message::Message::user().with_text("What is 3+3?")];
