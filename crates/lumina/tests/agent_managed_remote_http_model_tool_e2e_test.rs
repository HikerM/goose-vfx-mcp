...
use lumina::agents::extension_manager::{ExtensionManager, ExtensionManagerCapabilities};
use lumina::agents::{
    Agent, AgentConfig, AgentEvent, ExtensionConfig, LuminaPlatform, SessionConfig,
};
...
use lumina::providers::api_client::{ApiClient, AuthMethod};
use lumina::providers::base::Provider;
use lumina::providers::openai::OpenAiProviderBuilder;
...
async fn agent_managed_remote_http_model_tool_round_trip() -> anyhow::Result<()> {
    ...
    let manager_provider: lumina::agents::types::SharedProvider =
