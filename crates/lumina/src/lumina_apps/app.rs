...
impl LuminaApp {
    ...
    const PRD_SCRIPT_TYPE: &'static str = "application/x-lumina-prd";
    const LUMINA_APP_TYPE: &'static str = "LuminaApp";
    const LUMINA_SCHEMA_CONTEXT: &'static str = "urn:io.github.hikerm.lumina:schema";
    ...
    pub fn from_html(html: &str) -> Result<Self, String> {
        ...
        let json_str = metadata_re
            ...
            .ok_or_else(|| "No LuminaApp JSON-LD metadata found in HTML".to_string())?
            .as_str();
    ...
    pub fn to_html(&self) -> Result<String, String> {
        ...
        let mut metadata = serde_json::json!({
            "@context": Self::LUMINA_SCHEMA_CONTEXT,
            "@type": Self::LUMINA_APP_TYPE,
...
pub async fn fetch_mcp_apps(
    ...
    session_id: &str,
) -> Result<Vec<LuminaApp>, ErrorData> {
