...
impl CursorAgentProvider {
    ...
    /// Convert lumina messages to a simple prompt format for cursor-agent CLI
    ...
    async fn execute_command(
        ...
        if std::env::var("LUMINA_CURSOR_AGENT_DEBUG").is_ok() {
...
impl lumina_providers::base::ProviderDescriptor for CursorAgentProvider {
