...
use lumina_providers::formats::openai::is_openai_responses_model;
...
use lumina_providers::formats::openai::{create_request, get_usage, response_to_message};
use lumina_providers::formats::openai_responses::create_responses_request;
...
impl GithubCopilotProvider {
    ...
    pub async fn from_env(
        ...
        let client_id: String = config.get_param("GITHUB_COPILOT_CLIENT_ID").map_err(|_| {
            anyhow::anyhow!(
                "GitHub Copilot OAuth requires a distributor-approved GITHUB_COPILOT_CLIENT_ID"
            )
        })?;
...
impl lumina_providers::base::ProviderDescriptor for GithubCopilotProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            GITHUB_COPILOT_PROVIDER_NAME,
            "GitHub Copilot",
            "GitHub Copilot. Run `lumina configure` and select copilot to set up.",
            ...
            vec![
                ...
                ConfigKey::new("GITHUB_COPILOT_CLIENT_ID", true, false, None, false),
