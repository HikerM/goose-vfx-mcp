...
use lumina_providers::api_client::TlsConfig;
use lumina_providers::base::ProviderDescriptor;
use lumina_providers::databricks::DatabricksProvider;
use lumina_providers::databricks_auth::{
...
fn resolve_instance_id() -> Option<String> {
    let enabled = Config::global()
        .get_param::<bool>("LUMINA_DATABRICKS_CLIENT_REQUEST_ID")
        .unwrap_or(false);
