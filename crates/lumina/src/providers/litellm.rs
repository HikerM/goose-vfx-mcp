...
impl lumina_providers::base::ProviderDescriptor for LiteLLMProvider {
...
impl Provider for LiteLLMProvider {
    ...
    async fn stream(
        ...
        let mut payload = lumina_providers::formats::openai::create_request(
            model_config,
            system,
            messages,
            tools,
        ...
        let message = lumina_providers::formats::openai::response_to_message(&response)?;
        let usage = lumina_providers::formats::openai::get_usage(&response);
