...
impl<'a> SystemPromptBuilder<'a, PromptManager> {
    ...
    pub fn with_lumina_mode(mut self, mode: LuminaMode) -> Self {
    ...
    pub fn build(self) -> String {
        ...
        let lumina_mode = self
            .lumina_mode
            .unwrap_or_else(|| Config::global().get_lumina_mode().unwrap_or_default());
        ...
        let context = SystemPromptContext {
            ...
            lumina_mode,
            is_autonomous: lumina_mode == LuminaMode::Auto,
...
mod tests {
    ...
    async fn test_all_platform_extensions() {
        ...
        let _guard = env_lock::lock_env([
            ...
            ("LUMINA_PATH_ROOT", Some(temp_root.as_str())),
        ]);
