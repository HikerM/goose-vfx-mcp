...
const MANAGED_DOCKER_ISOLATION_KEY: &str = "__luminaManagedDockerIsolation";
...
pub enum ExtensionConfig {
    ...
    /// Built-in extension that is part of the bundled lumina MCP server
...
mod tests {
    ...
    fn managed_docker_isolation_survives_config_round_trip_but_is_not_inferred() {
        ...
        let user = Envs::new(HashMap::from([(
            "__luminaManagedDockerIsolation".to_string(),
            "true".to_string(),
        )]));
