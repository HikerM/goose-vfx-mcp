...
impl From<RecipeSettingsDto> for Settings {
    fn from(dto: RecipeSettingsDto) -> Self {
        Self {
            lumina_provider: dto.lumina_provider,
            lumina_model: dto.lumina_model,
...
impl From<Settings> for RecipeSettingsDto {
    fn from(settings: Settings) -> Self {
        Self {
            lumina_provider: settings.lumina_provider,
            lumina_model: settings.lumina_model,
...
) -> Result<lumina_sdk_types::custom_requests::RecipeListEntryDto> {
    Ok(lumina_sdk_types::custom_requests::RecipeListEntryDto {
        id,
    ...
    fn converts_recipe_dto_to_recipe_and_back() {
        let dto = RecipeDto {
            ...
            settings: Some(RecipeSettingsDto {
                lumina_provider: Some("openai".to_string()),
                lumina_model: Some("gpt-5".to_string()),
