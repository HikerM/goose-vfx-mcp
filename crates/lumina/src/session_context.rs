...
pub fn session_id_request_builder() -> lumina_providers::api_client::RequestBuilderDecorator {
...
/// Local OS user recorded in local session metadata.
...
/// Hostname recorded in local session metadata.
