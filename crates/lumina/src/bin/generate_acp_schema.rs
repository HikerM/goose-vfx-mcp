use lumina::acp::custom_notifications::custom_notification_schemas;
use lumina::acp::server::{agent_request_schemas, available_custom_method_schemas};
...
fn is_unstable_method(method: &str) -> bool {
    method.contains("_lumina/unstable")
}
