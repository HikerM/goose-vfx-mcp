...
/// Lumina-specific credential store that uses the Config system
///
/// This implementation stores OAuth credentials in the lumina configuration
/// system, which handles secure storage (e.g., keychain integration).

#[derive(Clone)]
pub struct LuminaCredentialStore {
    name: String,
}

impl LuminaCredentialStore {
...
impl CredentialStore for LuminaCredentialStore {
