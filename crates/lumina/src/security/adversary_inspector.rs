...
///
/// Activated by placing an `adversary.md` file in the Lumina config directory
/// (`~/.config/lumina/adversary.md`). The file contains optional frontmatter
...
mod tests {
    ...
    async fn test_disabled_when_no_adversary_md() {
        ...
        let results = inspector
            .inspect("test", &[request], &[], LuminaMode::Auto)
            .await
            .unwrap();
