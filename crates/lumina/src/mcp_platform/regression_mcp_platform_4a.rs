...
async fn manual_http_rejects_loopback_private_literals_and_persists_a_disabled_plan() {
    ...
    let task = service
        ...
        .await
        .unwrap();
    assert_eq!(task.status, lumina::mcp_platform::TaskStatus::Queued);
...
async fn public_service_constructors_are_read_only_even_with_public_request_context() {
    ...
    for error in [
        ...
        service
            .profile_update(
                &context,
                lumina::mcp_platform::ProfileUpdateInput {
        ...
        service
            .profile_restore(
                &context,
                lumina::mcp_platform::ProfileRestoreInput {
                    profile_id: "profile_1".to_string(),
                    source_revision: 1,
                    expected_revision: 1,
        ...
        service
            .profile_archive(
                &context,
                lumina::mcp_platform::ProfileArchiveInput {
                    profile_id: "profile_1".to_string(),
                    expected_revision: 1,
        ...
        service
            .profile_apply_plan_create(
                &context,
                lumina::mcp_platform::ProfileApplyPlanInput {
                    profile_id: "profile_1".to_string(),
                    profile_revision: 1,
