...
const KEYRING_SERVICE: &str = "lumina-mcp-platform-credential-authority-v1";
#[cfg(feature = "system-keyring")]
const ROOT_ACCOUNT: &str = "credential-authority/root";
#[cfg(feature = "system-keyring")]
const ANCHOR_KEYRING_SERVICE: &str = "lumina-mcp-platform-credential-authority-anchor-v1";
#[cfg(feature = "system-keyring")]
const ANCHOR_ROOT_ACCOUNT: &str = "credential-authority-anchor/root";
const ROOT_NAMESPACE: &str = "lumina.mcp-platform.credential-authority";
const ANCHOR_ROOT_NAMESPACE: &str = "lumina.mcp-platform.credential-authority.anchor-root";
const HANDLE_ANCHOR_NAMESPACE: &str = "lumina.mcp-platform.credential-authority.handle-anchor";
const ENVELOPE_DOMAIN: &[u8] = b"lumina.mcp-platform.credential-authority";
...
impl RemoteInspectionTargetAuthority {
    ...
    fn proof_hmac(
        ...
        digest.update(b"lumina.mcp-platform.remote-inspection.no-live-proof.v1");
