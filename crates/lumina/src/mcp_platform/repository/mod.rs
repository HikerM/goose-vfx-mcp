...
//!
//! ```compile_fail
//! # async fn demo(repo: &lumina::mcp_platform::SqliteMcpPlatformRepository) {
...
pub(crate) const PROJECTION_WITNESS_V2_DOMAIN: &str = "lumina.mcp-platform.projection-witness";
