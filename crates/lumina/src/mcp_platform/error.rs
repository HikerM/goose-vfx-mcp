...
pub const MANAGED_STORAGE_ROOT_UNAVAILABLE_MESSAGE: &str = "Managed MCP storage on Windows is unavailable. Choose or repair a regular writable folder on D and restart Lumina before retrying.";
