...
pub(crate) const SOURCE_PROVISIONING_DESCRIPTOR_FORMAT: &str = "lumina-source-provisioning-v1";
...
const SNAPSHOT_DIGEST_DOMAIN: &[u8] = b"lumina-source-provisioning-snapshot-v1\0";
const DESCRIPTOR_DIGEST_DOMAIN: &[u8] = b"lumina-source-provisioning-descriptor-v1\0";
const TRANSPORT_SESSION_BINDING_DIGEST_DOMAIN: &[u8] =
    b"lumina-source-provisioning-transport-session-binding-v1\0";
