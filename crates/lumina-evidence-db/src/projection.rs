...
pub(crate) struct AttemptRow {
    ...
    pub(crate) source_id: Option<Vec<u8>>,
    pub(crate) sequence: Option<u64>,
    pub(crate) doc_kind: Option<lumina_verified_sources::DocKind>,
    pub(crate) parent_document_digest: Option<lumina_verified_sources::Digest32>,
    ...
    pub(crate) document_digest: Option<lumina_verified_sources::Digest32>,
    pub(crate) root_digest: Option<lumina_verified_sources::Digest32>,
    pub(crate) state_digest: Option<lumina_verified_sources::Digest32>,
    pub(crate) signature_set_digest: Option<lumina_verified_sources::Digest32>,
    pub(crate) signature_message_digest: Option<lumina_verified_sources::Digest32>,
    pub(crate) verified_fact_id: Option<i64>,
}
...
pub(crate) trait VerifiedFactExt {
    fn to_resolved_document(&self) -> lumina_verified_sources::ResolvedDocument;
}

impl VerifiedFactExt for VerifiedFactRecord {
    fn to_resolved_document(&self) -> lumina_verified_sources::ResolvedDocument {
        lumina_verified_sources::ResolvedDocument {
