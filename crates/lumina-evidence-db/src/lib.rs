...
use lumina_verified_sources::{Digest32, DocKind, DocumentDigests};
...
pub(crate) const SCHEMA_VERSION: &str = "lumina-evidence-db/pre-a0.2";
...
pub enum IngestDisposition {
    ParseRejected {
        error: lumina_verified_sources::ErrorCode,
    },
    ChainRejected {
        error: lumina_verified_sources::ErrorCode,
    },
