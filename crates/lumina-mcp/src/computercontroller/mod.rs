...
impl ComputerControllerServer {
    pub fn new() -> Self {
        ...
        // - macOS/Linux: ~/.cache/lumina/computer_controller/
        // - Windows:     ~\AppData\Local\Block\lumina\cache\computer_controller\
        ...
        Self {
            ...
            http_client: Client::builder().user_agent("lumina/1.0").build().unwrap(),
            instructions,
            system_automation,
            #[cfg(target_os = "macos")]
